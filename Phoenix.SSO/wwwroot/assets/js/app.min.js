...
function ($) {
    ...
    */
    App.prototype.initControls = function () {
        ...
        // document.getElementById("loginButton").addEventListener("click", showWaiting);
...
function showWaiting() {
    ...
    $("#waitingText").removeClass("d-none")
}

function refreshCaptcha(){
    const possible = "ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";
    const random = Math.random;
    const captcha = Array.from({ length: 6 }, () => possible[Math.floor(random() * possible.length)]).join('');
